  ...
  const handleExportToExcel = () => {
    ...
    const exportData = tenants.map((tenant, index) => {
      ...
      return {
        ...
        "Email": tenant.email,
        "Mobile Number": tenant.mobileNumber || "",
        "Business Address": tenant.businessAddress || "",
        "City": tenant.city || "",
        "State": tenant.state || "",
        "Pincode": tenant.pincode || "",
        "PAN Number": tenant.panNumber || "",
        "GST Number": tenant.gstNumber || "",
        "Industry Type": tenant.industryType || "",
        "Existing Accounting Software": tenant.existingAccountingSoftware || "",
        "Plan Type": tenant.planType || "",
        "Subscription Plan ID": tenant.subscriptionPlanId || "",
        "Subscription Plan": plan ? plan.name : "No Plan",
        "Allowed Modules": tenant.allowedModules?.join(", ") || "",
        "Custom Modules": tenant.customModules?.join(", ") || "",
        ...
        "Activated Date": tenant.activatedAt ? format(new Date(tenant.activatedAt), "dd MMM yyyy") : "",
      };
    });
