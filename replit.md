...
*   **Communication Integrations**:
    *   **Email**: Nodemailer integration supporting Gmail OAuth2/SMTP, advanced template management with 35+ variables, a visual variable picker, professional HTML templates, intelligent variable enrichment, absolute URL generation, and a 2-column editor layout.
